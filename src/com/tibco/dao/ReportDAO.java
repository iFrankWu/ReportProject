...
public class ReportDAO {
    ...
    public void updateReportStatus(Integer reportId, String reportStatus) throws DBException {
        String sql = "update report  set  report_status =? where reportId=?";
        List<FieldParameter> fpList = new ArrayList<FieldParameter>();
        fpList.add(new FieldParameter(1, reportStatus, FieldTypes.VARCHAR));
    ...
    public List<Report> getReportByStatus(String reportStatus) throws DBException {
        String sql = "select * from report where report_status = ?  and  isDelete= false";
        List<FieldParameter> fpList = new ArrayList<FieldParameter>();
        fpList.add(new FieldParameter(1, reportStatus, FieldTypes.VARCHAR));
        return (List<Report>) db.queryPrepareList(Report.class, sql, fpList);
    }
    public Report getLastReport() throws DBException {
        ...
        List<FieldParameter> fplist = new ArrayList<FieldParameter>();
        returnBean = (Report) db.queryFirst(Report.class, sql);
        return returnBean;
    }
