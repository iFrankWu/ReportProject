...
public class Report {
    ...
    public String toString() {
        return "Report{" +
                ...
                ", childbirthNumber=" + childbirthNumber +
                ", isMenopause=" + isMenopause +
                ", department='" + department + '\'' +
                ", phone='" + phone + '\'' +
                ", isLeucorrhea=" + isLeucorrhea +
                ", isBleed=" + isBleed +
                ", unregularBleed='" + unregularBleed + '\'' +
                ", otherComplaints='" + otherComplaints + '\'' +
                ", isSmooth=" + isSmooth +
                ", isAcuteInflammation=" + isAcuteInflammation +
                ", isHypertrophy=" + isHypertrophy +
                ", isPolyp=" + isPolyp +
                ", erosion='" + erosion + '\'' +
                ", isTear=" + isTear +
                ", isNesslersGlandCyst=" + isNesslersGlandCyst +
                ", isWhite=" + isWhite +
                ", isCancer=" + isCancer +
